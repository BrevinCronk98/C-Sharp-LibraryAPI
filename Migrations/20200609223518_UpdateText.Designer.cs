...
namespace APIPractice.Migrations
{
    ...
    [Migration("20200609223518_UpdateText")]
            ...
            modelBuilder.Entity("LibraryAPI.Models.Story", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StoryId = 1,
                            StoryDetails = " Id love to have an adventure  To different worlds where my heart can fly  To different worlds where my heart desires  And will be remembered until I die.  Id love to have an adventure  Along with my precious pen  And write down all the things Ive witnessed  And read it all again.  Id love to have an adventure  Through the darkest part of the forest  And meet the greatest beasts  And see who is the toughest.  Id love to have an adventure  Through the deepest part of the sea  Where a place I can find peace  As if there is no living creature but me.  Id love to have an adventure  Where mysterious mountains hide secrets  Then Ill climb to its toppest part  By ignoring the chirping crickets.  Id love to have an adventure  Where I can be my fullest self  Together with my loved ones  And finish the books on the shelf.  Id love to have an adventure  With my eyes that is sharper than knife  Ill face my battles, brave and humble  Until I get to the Everlasting Life ",
                            StoryName = "Id Love To Have An Adventure"
                        },
                        new
                        {
                            StoryId = 2,
                            StoryDetails = " Like crunchy cornflakes  Gold leaves rustle underfoot  Beauty in decay. ",
                            StoryName = "Octobers Gold"
                        },
                        new
                        {
                            StoryId = 3,
